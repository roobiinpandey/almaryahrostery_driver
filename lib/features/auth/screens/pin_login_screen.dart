...
class _PinLoginScreenState extends State<PinLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      final result = await _authService.loginWithPin(_pin, false);
  ...
  void _navigateToQRLogin() {
    Navigator.of(
      context,
    ).push(MaterialPageRoute(builder: (context) => const QRLoginScreen()));
  }
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  label: const Text(
                    'Scan QR Badge',
                    style: TextStyle(color: AppTheme.primaryOliveGold),
                  ),
                ),
